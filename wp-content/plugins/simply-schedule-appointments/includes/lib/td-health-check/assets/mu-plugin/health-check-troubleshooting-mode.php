...
class TD_Health_Check_Troubleshooting_MU {
	...
	/**
	 * TD_Health_Check_Troubleshooting_MU constructor.
	 */
	...
	public function test_site_state() {
		...
		// Make sure the TD_Health_Check_Loopback class is available to us, in case the primary plugin is disabled.
		if ( ! method_exists( 'TD_Health_Check_Loopback', 'can_perform_loopback' ) ) {
		...
		$loopback_state = TD_Health_Check_Loopback::can_perform_loopback();
...
new TD_Health_Check_Troubleshooting_MU();
