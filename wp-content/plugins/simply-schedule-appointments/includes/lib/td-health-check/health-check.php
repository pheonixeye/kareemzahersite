...
define( 'TD_HEALTH_CHECK_PHP_MIN_VERSION', '5.6' );
...
define( 'TD_HEALTH_CHECK_MYSQL_REC_VERSION', '5.6' );

// Set the plugin version.
define( 'TD_HEALTH_CHECK_PLUGIN_VERSION', '1.2.1' );

// Set the absolute path for the plugin.
define( 'TD_HEALTH_CHECK_PLUGIN_DIRECTORY', plugin_dir_path( __FILE__ ) );

// Set the plugin URL root.
define( 'TD_HEALTH_CHECK_PLUGIN_URL', plugins_url( '/', __FILE__ ) );

// Set the current cURL version.
define( 'TD_HEALTH_CHECK_CURL_VERSION', '7.58' );

// Set the minimum cURL version that we've tested that core works with.
define( 'TD_HEALTH_CHECK_CURL_MIN_VERSION', '7.38' );
